...
import fragmentShader from "./shaders/pentagon.frag";
import vertexShader from "./shaders/pentagon.vert";

export default class PentagonMode {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.drawData = new PentagonData();
