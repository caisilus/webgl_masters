...
export default class CubeWithNormalsData implements DrawData {
  ...
  get vertices(): Float32Array {
    ...
    return new Float32Array(
      [ // X, Y, Z           R, G, B
        // Top
        1.0, 1.0, -1.0,    colors.top, facesNormals.top,
        1.0, 1.0, 1.0,     colors.top, facesNormals.top,
        -1.0, 1.0, 1.0,    colors.top, facesNormals.top,
        -1.0, 1.0, -1.0,   colors.top, facesNormals.top,

        // Left
        -1.0, 1.0, 1.0,    colors.left, facesNormals.left,
        -1.0, -1.0, 1.0,   colors.left, facesNormals.left,
        -1.0, -1.0, -1.0,  colors.left, facesNormals.left,
        -1.0, 1.0, -1.0,   colors.left, facesNormals.left,

        // Right
        1.0, 1.0, 1.0,    colors.right, facesNormals.right,
        1.0, -1.0, 1.0,   colors.right, facesNormals.right,
        1.0, -1.0, -1.0,  colors.right, facesNormals.right,
        1.0, 1.0, -1.0,   colors.right, facesNormals.right,

        // Front
        1.0, 1.0, 1.0,    colors.front, facesNormals.front,
        1.0, -1.0, 1.0,   colors.front, facesNormals.front,
        -1.0, -1.0, 1.0,  colors.front, facesNormals.front,
        -1.0, 1.0, 1.0,   colors.front, facesNormals.front,

        // Back
        1.0, 1.0, -1.0,   colors.back, facesNormals.back,
        1.0, -1.0, -1.0,  colors.back, facesNormals.back,
        -1.0, -1.0, -1.0, colors.back, facesNormals.back,
        -1.0, 1.0, -1.0,  colors.back, facesNormals.back,

        // Bottom
        -1.0, -1.0, -1.0, colors.bottom, facesNormals.bottom,
        -1.0, -1.0, 1.0,  colors.bottom, facesNormals.bottom,
        1.0, -1.0, 1.0,   colors.bottom, facesNormals.bottom,
        1.0, -1.0, -1.0,  colors.bottom, facesNormals.bottom,
      ].flat()
  ...
  vertexAttributes(gl: WebGL2RenderingContext): VertexAttribute[] {
    return VertexAttribute.attributesForVertexWithNormals(gl);
  }
}